...
def move_boss(dungeon, player_position, boss_position, original_tile):
    r, c = boss_position
    ...
    return dungeon, closest_tile  # Return the updated dungeon and new Boss position
...
def main(settings):
    ...
    while running and player["health"] > 0:
        ...
        if boss_placed and player_moves % 5 == 0 and moved:
            dungeon, boss_position = move_boss(dungeon, player["position"], boss_position, original_tile)
